...
class ProvinceController extends Controller 
{
	...
	public function actionIndex() 
	{
		...
		$model->attributes = $_POST['ProvinceForm'];
		$whereInfo = $this->getSearchInfo($model->attributes);
		
		$dataModel = new linkProvince();
		...
		$from = ($p-1)*$limit;
		$page_nums = 10;
		$page = new sdkPage($total,$p,$limit,$page_nums,"/mywork/province/index/page/");
	...
	public function actionAdd()
	{
		...
		if (isset($_POST['ProvinceForm'])) {
			...
			if($model->validate()){
				...
				$this->showmsg("操作成功",'/mywork/province');
			}
		}
		$data['model'] = $model;
		$data['options'] = $model->getOptionName();
