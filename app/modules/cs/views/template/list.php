						...
						<?php
							foreach( $info as $n => $v){
								...
								echo '
										...
										<td class="link_bt"  valign="bottom">'.$params['templateType'][$v['type']].'</td>
										
										<td class="link_bt"  valign="bottom"><img src="/'.$params['picPath'].date("Y",$a[0])."/".date("m",$a[0])."/".$v['pic'].'" width=50 height = 70/></td>
