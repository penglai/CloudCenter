             ...
             <tr>
              ...
              <tr>
			   ...
			   <tr>
				...
				<?php echo $form->radioButtonList($model,'type', array('1'=>'封面','2'=>'列表','3'=>'内容'), array('separator'=>'&nbsp;','labelOptions'=>array('style'=>'font-size:12px;')) )?>
				</td>
			  ...
			  <tr>
                ...
                <td width="3%" bgcolor="#f2f2f2">&nbsp;</td>
                <td width="50%" height="30" bgcolor="#f2f2f2">
				<?php echo $form->radioButtonList($model,'status', array('1'=>'有效','2'=>'无效'), array('separator'=>'&nbsp;','labelOptions'=>array('style'=>'font-size:12px;')) )?>
				</td>
                <td width="10%" height="30"  class="left_txt" bgcolor="#f2f2f2">
				<span style = "color:green">*</span>
