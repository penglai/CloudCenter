      ...
      <tr>
        <td valign="top"><table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            ...
            <td align="right" width="60" class="left_txt"><a href="/cs/user/"><img src="/static/admin/images/back.gif"></a>&nbsp;&nbsp;<a href="/cs/user/">返回</a></td>
          </tr>
          <tr>
            ...
            <td colspan="3"><table width="100%" border="0" cellspacing="0" cellpadding="0">
			 <?php $form = $this->beginWidget('CActiveForm'); ?>
			  ...
			  <tr>
				...
				<?php echo $options['name'];?>（无单位填联系人名称）
				</td>
              </tr>
			  ...
			  <tr>
                ...
                <td width="3%" >&nbsp;</td>
                <td width="32%" height="30" >
				 <?php echo $form->textField($model,'userTel',array('size'=>'20','value'=>$model->userTel)); ?>
				</td>
                <td width="45%" height="30"  class="left_txt">
				<span style = "color:green">*</span>
				<?php echo $form->error($model,'userTel'); ?>
				<?php echo $options['userTel'];?>
				</td>
              </tr>
			  ...
			  <tr>
                <td width="20%" height="30" bgcolor="#f2f2f2" align="right"  class="left_txt2"><?php echo $options['introduct'];?>：</td>
                <td width="3%" bgcolor="#f2f2f2">&nbsp;</td>
                <td width="50%" height="30" bgcolor="#f2f2f2">
				<?php echo $form->textArea($model,'introduct',array('rows'=>2,'cols'=>50,'value'=>$model->introduct,'style'=>'font-size:12px;')); ?>
				</td>
                <td width="10%" height="30"  class="left_txt" bgcolor="#f2f2f2">
				<?php echo $options['introduct'];?>
				</td>
              </tr>	
